...
import { StatsWidget } from "@/components/share/StatsWidget";
import { RecentSharesWidget } from "@/components/share/RecentSharesWidget";
...
export default function Home() {
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans">
      <Header />
      <main className="flex-1 container mx-auto p-4 md:p-6 lg:p-8 max-w-7xl flex flex-col lg:flex-row gap-8">
